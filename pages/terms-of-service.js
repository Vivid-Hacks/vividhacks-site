...
const TOS = () => {
  return (
    <div className={styles.container}>
      ...
      <h4 className={styles.update}>Last updated August 23, 2021</h4>
      <h2 className={styles.heading}>AGREEMENT TO TERMS</h2>
      <p>
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ({'“'}you{'“'}) and Vivid
        Hacks ({'"'}Company,{'"'} “we,{'"'} “us,{'"'} or {'“'}our{'“'}), concerning your access to and
        use of the htttps://http://www.vividhacks.tk website as well as any
        ...
        “Site”). We are registered in Indiana, United States and have our
        registered office at IN46032. You agree that by accessing the Site, you
      ...
      <p>
        ...
        permission to use the Site; (4) you will not access the Site through
        automated or non-human means, whether through a bot, script, or
        otherwise; (5) you will not use the Site for any illegal or unauthorized
        purpose; and (6) your use of the Site will not violate any applicable
        law or regulation.
      </p>
      <p>
      ...
      <p>
        ...
        Policy: https://www.vividhacks.tk/privacy-policy. By using the Site, you
        ...
        tothe United States, and you agree to have your data transferred to and
        processed in the United States. Further, we do not knowingly accept,
      ...
      <p>
        ...
        Indiana, without regard to its conflict of law principles
      </p>
      ...
      <p>
        ...
        inCarmel,Indiana, and the Parties hereby consent to, and waive all
        defenses of lack of personal jurisdiction and forum non conveniens with
        respect to venue and jurisdiction in suchstate and federal courts.
      ...
      <div className={styles.contactus}>
        <strong>Vivid Hacks</strong>
        <strong>IN 46032</strong>
        <strong>United States</strong>
        <strong>vividhacks@gmail.com</strong>
      </div>
    </div>
  );
};
