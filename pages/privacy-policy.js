...
const PP = () => {
  return (
    <div
      style={{ paddingLeft: "20px", paddingLeft: "20px", paddingTop: "50px" }}
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Vivid Hacks.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Vivid Hacks, accessible from{" "}
            <a
              href="https://www.vividhacks.tk"
              target="_blank"
              rel="noreferrer"
            >
